...
describe('functions', () => {
    describe('declaring them', () => {
        ...
        describe('arguments to functions', () => {
            ...
            it('default values for paremeters', () => {
            ...
            it('you can use the rest operator thing', () => {
        ...
        describe('higher order functions', () => {
            // A function that takes one or two more arguments that are functions and/or
            // return a function
